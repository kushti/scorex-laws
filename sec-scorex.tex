...
\item{\em memory pool} contains temporary objects to be packed into persistent modifiers. An unconfirmed transaction is the clear example of an object living in the pool.
\end{itemize}
